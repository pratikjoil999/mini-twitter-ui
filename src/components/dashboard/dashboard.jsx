      ...
      <div className="dashboard" >
        ...
        {this.state.showSearchList ?  
          <div className="search_container">
            ...
            <Link to="/tweetSearch" ><div class="tweet-box row ml-0 p-0 pb-3 cursor_pointer" onClick={this.redirectToTweetSearch}>
                <div class="col-10 p-0">
                  <div class="tweet-text-div-hash col-12 p-0 mt-3">
                    <div className="user_name">{"Search Tweet for "+ this.state.search}</div>
                  </div>
                </div>
              </div>
              </Link>
            ...
            <div class="tweet-box row ml-0 p-0 pb-3 cursor_pointer" >
                <div class="col-10 p-0">
                  <div class="tweet-text-div-hash col-12 p-0 mt-3">
                    <div className="user_name">{"Search Results for "+ this.state.search}</div>
                  </div>
                </div>
              </div>
              : null}
            ...
            <div class="tweet-box row ml-0 p-0 pb-3">
                ...
                <div class="col-10 p-0">
                  <div class="tweet-text-div col-12 p-0 mt-3">
                    ...
                    {tweet._id === localStorage.getItem("id") ? null : 
                    this.state.followingData.includes(tweet.id) ?  
                    <button
                    type="button"
